...
func (_m *PostUseCase) AddPost(dataPost posts.Core) (err error) {
...
func (_m *PostUseCase) UpdatePost(dataPost posts.Core, ID int) (err error) {
...
func (_m *PostUseCase) DestroyPost(ID int) (err error) {
	ret := _m.Called(ID)
