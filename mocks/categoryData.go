...
func (_m *CategoryData) Insert(dataPost categories.Core) (row int, err error) {
...
func (_m *CategoryData) Get() (dataPost []categories.Core, err error) {
	ret := _m.Called()
...
func (_m *CategoryData) Update(dataPost categories.Core, ID int) (row int, err error) {
...
func (_m *CategoryData) Destroy(ID int) (row int, err error) {
	ret := _m.Called(ID)
